    ...
    def __init__(self, n_object_features, C=1.0, tol=1e-4, normalize=True,
        ...
        """
            ...
            **kwargs
            ...
            References
            ----------
                [1] Joachims, T. (2002, July). "Optimizing search engines using clickthrough data.", Proceedings of the
                eighth ACM SIGKDD international conference on Knowledge discovery and data mining (pp. 133-142). ACM.
        """
